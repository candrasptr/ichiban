...
<div class="section-body">
  ...
  <div class="row">
    <!-- <div class="col-md-6">
      <div class="card">
        <div class="card-body">
          <form action="/waiter_filter_penjualan_belum_diantar" class="row" method="GET">
      ...
      <div class="card-header row">
                    ...
                    <div class="col-md-4 offset-md-4 align-items-end d-flex flex-column">
                        <div>
                            ...
                            <a href="/pesanan" class="btn btn-outline-danger">Selesai</a>
                            <a href="/belumdiantar" class="btn btn-danger">Transaksi</a>
                  ...
                  <tbody class="mt-2">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="{{ route('waiter.selesai',$item->id_transaksi) }}" class="btn btn-success btn-block confirm_script mb-2">Selesai</a>
                      </td>
                  </tr>
                    @endforeach
                  </tbody>
...
$(".confirm_script").click(function(e) {
  ...
  swal({
      title: 'Yakin menyelesaikan waiter?',
