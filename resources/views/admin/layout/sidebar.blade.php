      ...
      <ul class="sidebar-menu">
        ...
        {{-- <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li class="@yield('masakan')"><a class="nav-link" href="/masakan"><i class=""></i> <span>Coffee</span></a></li>
            <li class="@yield('masakan')"><a class="nav-link" href="/adminminuman"><i class=""></i> <span>Non Coffee</span></a></li>
            <li class="@yield('masakan')"><a class="nav-link" href="/admindessert"><i class=""></i> <span>Makanan</span></a></li>
          </ul>
        </li> --}}
        {{-- User --}}
        {{-- <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="@yield('user')"><a class="nav-link" href="/pelayanindex"><i class=""></i> <span>Pelayan</span></a></li>
        ...
        <li class="@yield('bahanbaku')"><a class="nav-link" href="/bahanbaku"><i class="ion ion-ios-copy"></i> <span>Bahan Baku</span></a></li>
      </ul>
  </aside>
</div>