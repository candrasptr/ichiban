...
<div class="card">
  ...
  <div class="card-body">
    <form action="{{route('masakan.prosesedit',$data->id_masakan)}}" method="POST" enctype="multipart/form-data">
      @csrf
      {{-- @method('patch') --}}
    <div class="row">
      <div class="col-md-2 mt-4 mb-2">
        <img src="{{ asset('assets/img/produk/'.$data->gambar_masakan) }}" width="150" class="img-thumbnail mr-3" align="left" id="preview">
      </div>
      <div class="col-md-10">
        <label>Pilih Gambar Masakan</label>
          <div class="form-group">
            <div class="custom-file">
              <input name="gambar_masakan" value="{{ $data->gambar_masakan }}" type="file" accept="image/x-png,image/gif,image/jpeg" class="form-control" id="inputGambar_masakan" placeholder=" masukan file gambar buku" name="gambar">
