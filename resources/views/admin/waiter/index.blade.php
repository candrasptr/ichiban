        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <a href="{{ route('waiter.tambah') }}" class="btn btn-icon icon-left btn-danger mb-3 px-3"><i
                            ...
                            <tbody class="mt-2">
                                @foreach ($data as $no => $dt)
                                    <tr>
                                        ...
                                        <td>{{ $dt->username }}</td>
                                        <td>
                                            <a href="{{ route('waiter.edit', $dt->id_waiter) }}" class="btn btn-success"><i
                                                    class="fas fa-edit"></i></a>
                                            <a href="#" data-id=""
                                                class="btn btn-danger confirm_script-{{ $dt->id_waiter }} mr-3">
                                                <form action="{{ route('waiter.delete', $dt->id_waiter) }}"
                                                    class="delete_form-{{ $dt->id_waiter }}" method="POST">
                                                    @method('DELETE')
                                                    @csrf
                                                </form>
